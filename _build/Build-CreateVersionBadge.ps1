# THIS SCRIPT IS USED TO GENERATE A NEW VERSION BATCH AND UPLOAD TO AZURE STORAGE ACCOUNT

# SAMPLE CALL:
# _build/Build-CreateVersionBadge.ps1 -identifier "nightly" -version "0.1.18353.02"
...
$keys = Get-AzureRmStorageAccountKey -StorageAccountName "rxtstorage" -ResourceGroupName "UwpCT"
$context = New-AzureStorageContext -StorageAccountName "rxtstorage" -StorageAccountKey $keys[0].value

Write-Host "Uploading badge to rxtstorage badges container..."
