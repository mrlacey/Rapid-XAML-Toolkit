    ...
    public static class RapidXamlDocumentCache
    {
        ...
        public static void Add(string file, ITextSnapshot snapshot)
        {
            ...
            else
            {
                ...
                var doc = RapidXamlDocument.Create(new RealTextSnapshot(snapshot), file, vsa, string.Empty);
                ...
                if (!CurrentlyProcessing.Contains(snapshotText))
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            doc = RapidXamlDocument.Create(new RealTextSnapshot(snapshot), file, vsa, string.Empty);
                        }
                        finally
                        {
                            sw.Stop();
