...
namespace RapidXamlToolkit.Tests.XamlAnalysis
{
    ...
    public class RealWorldIssues
    {
        ...
        public void Issue183()
        {
            ...
            var element = XamlElementProcessor.GetSubElementAtPosition(ProjectType.Wpf, "testFile.xaml", new RealTextSnapshot(new FakeTextSnapshot()), xaml.Replace("☆", string.Empty), offset, new DefaultTestLogger(), string.Empty, new TestVisualStudioAbstraction());
