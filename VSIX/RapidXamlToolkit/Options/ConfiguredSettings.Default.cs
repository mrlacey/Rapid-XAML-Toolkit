            ...
            var result = new Settings
            {
                ...
                Profiles = new List<Profile>
                {
                    ...
                    new Profile
                    {
                        ...
                        ProjectType = ProjectType.Uwp,
                        ClassGrouping = "StackPanel",
                        FallbackOutput = "<TextBlock Header=\"$namewithspaces$\" Text=\"{x:Bind ViewModel.$name$}\" />",
                        SubPropertyOutput = "<TextBlock Text=\"{x:Bind $name$, Mode=OneWay}\" />",
                        EnumMemberOutput = "<RadioButton Content=\"$element$\" GroupName=\"$enumname$\" />",
                    ...
                    new Profile
                    {
                        ...
                        FallbackOutput = "<TextBlock Header=\"$namewithspaces$\" Text=\"{x:Bind ViewModel.$name$}\" x:Name=\"$xname$\" RelativePanel.Below=\"$repxname$\" />",
                        SubPropertyOutput = "<TextBlock Text=\"{x:Bind $name$, Mode=OneWay}\" />",
                        EnumMemberOutput = "<RadioButton Content=\"$element$\" GroupName=\"$enumname$\" />",
