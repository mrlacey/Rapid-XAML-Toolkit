...
{
    public class AutoSuggestBoxAnalyzer : BuiltInXamlAnalyzer
    {
        public AutoSuggestBoxAnalyzer(IVisualStudioAbstraction vsa, ILogger logger)
            : base(vsa, logger)
        {
        }

        public override string TargetType() => Elements.AutoSuggestBox;
