...
{
    public class CalendarDatePickerAnalyzer : BuiltInXamlAnalyzer
    {
        public CalendarDatePickerAnalyzer(IVisualStudioAbstraction vsa, ILogger logger)
            : base(vsa, logger)
        {
        }

        public override string TargetType() => Elements.CalendarDatePicker;
