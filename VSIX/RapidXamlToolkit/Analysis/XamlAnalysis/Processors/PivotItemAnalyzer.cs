...
{
    public class PivotItemAnalyzer : BuiltInXamlAnalyzer
    {
        public PivotItemAnalyzer(IVisualStudioAbstraction vsa, ILogger logger)
            : base(vsa, logger)
        {
        }

        public override string TargetType() => Elements.PivotItem;
