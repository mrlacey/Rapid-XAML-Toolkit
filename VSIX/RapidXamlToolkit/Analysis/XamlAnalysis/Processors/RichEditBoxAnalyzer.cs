...
{
    public class RichEditBoxAnalyzer : BuiltInXamlAnalyzer
    {
        public RichEditBoxAnalyzer(IVisualStudioAbstraction vsa, ILogger logger)
            : base(vsa, logger)
        {
        }

        public override string TargetType() => Elements.RichEditBox;
