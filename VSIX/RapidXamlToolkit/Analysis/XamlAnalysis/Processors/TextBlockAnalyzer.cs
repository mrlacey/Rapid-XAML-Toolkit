...
{
    public class TextBlockAnalyzer : BuiltInXamlAnalyzer
    {
        public TextBlockAnalyzer(IVisualStudioAbstraction vsa, ILogger logger)
            : base(vsa, logger)
        {
        }

        public override string TargetType() => Elements.TextBlock;
