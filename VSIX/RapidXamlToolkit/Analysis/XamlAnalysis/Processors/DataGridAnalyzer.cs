...
{
    public class DataGridAnalyzer : BuiltInXamlAnalyzer
    {
        public DataGridAnalyzer(IVisualStudioAbstraction vsa, ILogger logger)
            : base(vsa, logger)
        {
        }

        public override string TargetType() => Elements.DataGrid;
